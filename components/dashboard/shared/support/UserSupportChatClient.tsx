        ...
        >
          ...
          {!isLoadingMessages && feed.length === 0 && (
            <div className="flex flex-col items-center justify-center py-20 text-center">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-cyan-500/10 text-cyan-400 ring-1 ring-cyan-400/20">
                <MessageSquareIcon className="h-5 w-5" />
              </div>
              <h3 className="mt-4 text-sm font-semibold text-white">Start the Conversation</h3>
              <p className="mt-2 max-w-xs text-xs leading-relaxed text-slate-500">
                Ask admin support any questions about viva guidelines, exam routines, or general issues. We are online and ready to help!
              </p>
            </div>
          )}
