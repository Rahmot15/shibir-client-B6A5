...
type WorkerSahayikaPdfViewerProps = {
  pdfUrl: string
}

export default function WorkerSahayikaPdfViewer({ pdfUrl }: WorkerSahayikaPdfViewerProps) {
  ...
  return (
    <section className="mt-6 rounded-2xl border border-emerald-500/25 bg-linear-to-b from-emerald-500/10 to-black/20 p-5">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h2 className="text-lg font-bold text-emerald-100">সাথী সহায়িকা</h2>
          <p className="text-sm text-emerald-200/80">বাটনে ক্লিক করে PDF ওপেন করে পড়তে পারবেন।</p>
        </div>
          ...
          <div className="overflow-x-auto">
            <div className="mx-auto w-fit rounded-lg border border-white/15 bg-white/95 p-1">
              <Document
                ...
                error={<p className="p-8 text-center text-xs text-rose-700">PDF load করতে সমস্যা হয়েছে।</p>}
              >
                <Page
